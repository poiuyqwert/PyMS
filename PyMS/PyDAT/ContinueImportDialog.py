...
class ContinueImportDialog(PyMSDialog):
	...
	def __init__(self, parent: UI.Misc, dattype: str, entry_id: int) -> None:
	...
	def widgetize(self) -> UI.Misc | None:
		UI.Label(self, text=f"You are about to import the {self.dattype} entry {self.id}, overwrite existing data?").pack(pady=10)
		frame = UI.Frame(self)
