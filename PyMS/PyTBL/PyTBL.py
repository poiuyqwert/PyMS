...
class PyTBL(MainWindow):
	def __init__(self, guifile=None):
		...
		self.toolbar.add_button('opendefault', self.open_default, 'Open Default TBL', Ctrl.d)
		self.toolbar.add_button('import', self.iimport, 'Import Strings', Ctrl.i)
		self.toolbar.add_gap()
		...
		self.toolbar.add_button('export', self.export, 'Export Strings', Ctrl.e, enabled=False, tags='file_open')
		self.toolbar.add_gap()
		self.toolbar.add_button('close', self.close, 'Close', Ctrl.w, enabled=False, tags='file_open')
		self.toolbar.add_section()
		self.toolbar.add_button('add', self.add, 'Add String', Key.Insert, enabled=False, tags='file_open')
		self.toolbar.add_button('insert', self.insert, 'Insert String', Shift.Insert, enabled=False, tags='string_selected')
		self.toolbar.add_button('remove', self.remove, 'Remove String (Delete in Listbox, Shift+Delete in Textbox)', Shift.Delete, enabled=False, tags='string_selected', add_shortcut_to_tooltip=False)
		self.toolbar.add_gap()
		self.toolbar.add_button('up', lambda e=None: self.movestring(e,0), 'Move String Up', Shift.Up, enabled=False, tags='string_selected', bind_shortcut=False)
		self.toolbar.add_button('down', lambda e=None: self.movestring(e,1), 'Move String Down', Shift.Down, enabled=False, tags='string_selected', bind_shortcut=False)
		self.toolbar.add_gap()
		self.toolbar.add_button('find', self.find, 'Find Strings', Ctrl.f, enabled=False, tags='file_open')
		self.toolbar.add_button('ffw', self.goto, 'Go to', Ctrl.g, enabled=False, tags='file_open')
		self.toolbar.add_gap()
		self.toolbar.add_button('test', self.preview, 'Test String', Ctrl.t, enabled=False, tags='string_selected')
		self.toolbar.add_section()
		self.toolbar.add_button('asc3topyai', self.mpqsettings, 'Manage Settings', Ctrl.m)
		self.toolbar.add_section()
		self.toolbar.add_button('register', self.register, 'Set as default *.tbl editor (Windows Only)', enabled=WIN_REG_AVAILABLE)
		self.toolbar.add_button('help', self.help, 'Help', Key.F1)
		self.toolbar.add_button('about', self.about, 'About PyTBL')
		self.toolbar.add_section()
