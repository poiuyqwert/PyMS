...
class RichList(Frame):
	...
	def __init__(self, parent, **kwargs):
		...
		self.text = Text(self, cursor='arrow', height=1, wrap=NONE, insertontime=0, insertofftime=65535, highlightthickness=0, xscrollcommand=self.hscroll.set, yscrollcommand=self.vscroll.set, exportselection=0, **kwargs)
