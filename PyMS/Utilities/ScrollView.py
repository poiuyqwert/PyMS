...
if __name__ == '__main__':
	...
	def add_scroll():
		...
		Entry(f, font=couriernew, width=10).pack(side=LEFT)
		f.pack(side=LEFT)
		f = Frame(r)
		Label(f, text='Fraction:', anchor=E).pack(side=LEFT)
		Entry(f, font=couriernew, width=3).pack(side=LEFT)
		f.pack(side=LEFT)
		r.pack(fill=X)
		f = Frame(s)
		x = Frame(f)
		Label(x, text='Shields:', width=9, anchor=E).pack(side=LEFT)
		Entry(x, font=couriernew, width=10).pack(side=LEFT)
		x.pack(side=LEFT)
		x = Frame(f)
		...
		Entry(f, font=couriernew, width=20).pack(side=LEFT, fill=X, expand=1)
		...
		Entry(f, font=couriernew, width=5).pack(side=LEFT)
		f.pack(fill=X)
		f = Frame(s)
		...
		Entry(f, font=couriernew, width=5).pack(side=LEFT)
		Label(f, text='=').pack(side=LEFT)
		Entry(f, font=couriernew, width=9).pack(side=LEFT)
		...
		Entry(f, font=couriernew, width=3).pack(side=LEFT)
		Label(f, text='=').pack(side=LEFT)
		Entry(f, font=couriernew).pack(side=LEFT, fill=X, expand=1, padx=2)
		Button(f, text='Jump ->').pack(side=LEFT)
		f.pack(fill=X)
		f = Frame(s)
		...
		Entry(t, font=couriernew).pack(side=LEFT, fill=X, expand=1)
		t.pack(side=LEFT, fill=X, expand=1)
		t = Frame(s)
		Label(t, text='Sight:', anchor=E).pack(side=LEFT)
		Entry(t, font=couriernew, width=2).pack(side=LEFT)
		t.pack(side=LEFT)
		t = Frame(s)
		Label(t, text='Target Acquisition Range:', anchor=E).pack(side=LEFT)
		Entry(t, font=couriernew, width=3).pack(side=LEFT)
		t.pack(side=LEFT)
		s.pack(fill=BOTH, padx=5, pady=5)
		l.pack(side=LEFT, fill=BOTH, expand=1)
