...
from .DATSettingsTab import DATSettingsTab
...
class SettingsDialog(BaseErrorableSettingsDialog[PyICEConfig]):
	def __init__(self, *, parent: UI.Misc, config: PyICEConfig, delegate: ErrorableSettingsDialogDelegate, err: PyMSError | None, mpq_handler: MPQHandler):
