...
definitions_registry: list[ActionDefinition] = [
    ...
    BasicActionDefinition(name='Wait', description='Wait for {0} milliseconds.', action_type=BriefingActionType.wait, parameters=(TimeParameter(),)),
    BasicActionDefinition(name='PlayWAV', description='Play {0} with duration {1}.', action_type=BriefingActionType.play_wav, parameters=(WAVParameter(), TimeParameter())),
    ...
    BasicActionDefinition(name='HidePortrait', description='Hide portrait in {0}.', action_type=BriefingActionType.hide_portrait, parameters=(SlotParameter(),)),
