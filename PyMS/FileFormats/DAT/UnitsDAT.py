...
class DATUnit(AbstractDAT.AbstractDATEntry):
	...
	def _export_data(self, export_properties: list[str] | None, data: OrderedDict[str, Any]) -> None:
		...
		self._export_property_value(export_properties, DATUnit.Property.hit_points, self.hit_points, data, property_encoder=_UnitPropertyCoder.hit_points)
		self._export_property_value(export_properties, DATUnit.Property.elevation_level, self.elevation_level, data)
		self._export_property_value(export_properties, DATUnit.Property.unknown_flags, self.unknown_flags, data, property_encoder=_UnitPropertyCoder.unknown_flags)
		...
		self._export_property_value(export_properties, DATUnit.Property.special_ability_flags, self.special_ability_flags, data, property_encoder=_UnitPropertyCoder.special_ability_flags)
		...
		self._export_property_value(export_properties, DATUnit.Property.staredit_placement_size, self.staredit_placement_size, data, property_encoder=_UnitPropertyCoder.staredit_placement_size)
		self._export_property_value(export_properties, DATUnit.Property.addon_position, self.addon_position, data, property_encoder=_UnitPropertyCoder.addon_position)
		self._export_property_value(export_properties, DATUnit.Property.unit_extents, self.unit_extents, data, property_encoder=_UnitPropertyCoder.unit_extents)
		...
		self._export_property_value(export_properties, DATUnit.Property.staredit_group_flags, self.staredit_group_flags, data, property_encoder=_UnitPropertyCoder.staredit_group_flags)
		self._export_property_value(export_properties, DATUnit.Property.supply_provided, self.supply_provided, data, property_encoder=_UnitPropertyCoder.supply_provided)
		self._export_property_value(export_properties, DATUnit.Property.supply_required, self.supply_required, data, property_encoder=_UnitPropertyCoder.supply_required)
		...
		self._export_property_value(export_properties, DATUnit.Property.staredit_availability_flags, self.staredit_availability_flags, data, property_encoder=_UnitPropertyCoder.staredit_availability_flags)
...
class UnitsDAT(AbstractDAT.AbstractDAT):
	...
	def get_entry(self, index: int) -> DATUnit:
		return cast(DATUnit, super().get_entry(index))
