...
all_types: list[CodeType.CodeType] = [
	PointCodeType(),
	OrderCodeType(),
	UnitIDCodeType(),
	UnitGroupCodeType(),
	AreaCodeType(),
	IssueOrderFlagsCodeType(),
	CompareTrigCodeType(),
	IdleOrderCodeType(),
	IdleOrderFlagsCodeType(),
	AttackModeCodeType(),
	AIControlCodeType(),
	SupplyCodeType(),
	RaceCodeType(),
	TimeCodeType(),
	ResourceCodeType(),
	LayoutActionCodeType(),
	BoolCompareCodeType(),
	AvailabilityCodeType(),
	RevealCodeType(),
	QueueFlagCodeType(),
	DefenseTypeCodeType(),
	DefenseDirectionCodeType(),
	BuildAtPointCodeType(),
	BuildAtFlagsCodeType(),
]
