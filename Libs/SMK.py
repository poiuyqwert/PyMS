...
class SMK:
	...
	RGB_LOOKUP = [0x00, 0x04, 0x08, 0x0C, 0x10, 0x14, 0x18, 0x1C,
	...
	VIDEO_BLOCK_SIZE_LOOKUP = [1,     2,    3,    4,    5,    6,    7,    8,
	...
	def load_data(self, data):
		...
		if framerate > 0:
			...
			fps = 10
		audio_sizes = struct.unpack('<7L', data[24:52]) # Unused?
		trees_size,mmap_size,mclr_size,full_size,type_size = struct.unpack('<5L', data[52:72])
